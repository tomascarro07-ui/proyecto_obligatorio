...
function mostrarCategorias() {
	...
	for(let i = 0; i < categorias.length; i++) {
		let categoria = categorias[i];
			filtroCategoria += `<div class="card"> <p>${categoria.nombreCategoria}</p> <button type="button" class="btn btn-secondary" data-accion="eliminar" data-nombre="${categoria.nombreCategoria}">Borrar Categoria</button></div>`;
	}
